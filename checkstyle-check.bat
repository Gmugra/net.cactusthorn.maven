...
@SET checkstyle-version=8.12
@SET checkstyle-jar=%project-maven-repo%\com\puppycrawl\tools\checkstyle\%checkstyle-version%\checkstyle-%checkstyle-version%-all.jar
